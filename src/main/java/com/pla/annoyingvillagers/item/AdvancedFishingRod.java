...
public class AdvancedFishingRod extends FishingRodItem {
    public AdvancedFishingRod() {
        super(com.pla.annoyingvillagers.util.LegacyItemProperties.create().stacksTo(1).durability(250));
    }
    ...
    public void appendHoverText(ItemStack stack, net.minecraft.world.item.Item.TooltipContext level, net.minecraft.world.item.component.TooltipDisplay display, java.util.function.Consumer<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.accept(Component.translatable("tooltip.annoyingvillagers.advanced_fishing_rod"));
    }
