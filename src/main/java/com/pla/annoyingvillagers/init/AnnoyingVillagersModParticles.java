...
import com.pla.annoyingvillagers.client.particle.ground_slam.GroundSlamParticle;
...
public class AnnoyingVillagersModParticles {
    ...
    public static void registerParticles(RegisterParticleProvidersEvent event) {
        ...
        event.registerSpriteSet(
                ...
                GroundSlamParticle.Provider::new
        );
        event.registerSpriteSet(
                AnnoyingVillagersModParticleTypes.SMOKE_WAVE.get(),
                SmokeWaveParticle.Provider::new
        );
    }
}
