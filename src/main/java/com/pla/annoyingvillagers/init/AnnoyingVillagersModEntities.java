...
public class AnnoyingVillagersModEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<BlueDemonEntity>> BLUE_DEMON = register("blue_demon", Builder.<BlueDemonEntity>of(BlueDemonEntity::new, MobCategory.MONSTER).notInPeaceful().setShouldReceiveVelocityUpdates(true).clientTrackingRange(126).updateInterval(3).fireImmune().sized(0.6F, 1.8F));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<InfectedTheMostMoistBurrit0Entity>> INFECTED_THEMOSTMOISTBURRIT0 = register("infected_the_most_moist_burrit0", Builder.<InfectedTheMostMoistBurrit0Entity>of(InfectedTheMostMoistBurrit0Entity::new, MobCategory.MONSTER).notInPeaceful().setShouldReceiveVelocityUpdates(true).clientTrackingRange(64).updateInterval(3).sized(0.6F, 1.8F));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<HerobrineCloneEntity>> HEROBRINE_CLONE = register("herobrine_clone", Builder.<HerobrineCloneEntity>of(HerobrineCloneEntity::new, MobCategory.MONSTER).notInPeaceful().setShouldReceiveVelocityUpdates(true).clientTrackingRange(64).updateInterval(3).fireImmune().sized(0.6F, 1.8F));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<TransporterHerobrineCloneEntity>> TRANSPORTER_HEROBRINE_CLONE = register("transporter_herobrine_clone", Builder.<TransporterHerobrineCloneEntity>of(TransporterHerobrineCloneEntity::new, MobCategory.MONSTER).notInPeaceful().setShouldReceiveVelocityUpdates(true).clientTrackingRange(64).updateInterval(3).fireImmune().sized(0.6F, 1.8F));
    public static final DeferredHolder<EntityType<?>, EntityType<HerobrineGregEntity>> HEROBRINE_GREG = register("herobrine_greg", Builder.<HerobrineGregEntity>of(HerobrineGregEntity::new, MobCategory.MONSTER).notInPeaceful().setShouldReceiveVelocityUpdates(true).clientTrackingRange(128).updateInterval(3).fireImmune().sized(0.6F, 1.8F));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<LowShadowHerobrineCloneEntity>> LOW_SHADOW_HEROBRINE_CLONE = register("low_shadow_herobrine_clone", Builder.<LowShadowHerobrineCloneEntity>of(LowShadowHerobrineCloneEntity::new, MobCategory.MONSTER).notInPeaceful().setShouldReceiveVelocityUpdates(true).clientTrackingRange(128).updateInterval(3).fireImmune().sized(0.6F, 1.8F));
    public static final DeferredHolder<EntityType<?>, EntityType<Herobrine7Entity>> HEROBRINE_7 = register("herobrine_7", Builder.<Herobrine7Entity>of(Herobrine7Entity::new, MobCategory.MONSTER).notInPeaceful().setShouldReceiveVelocityUpdates(true).clientTrackingRange(256).updateInterval(3).fireImmune().sized(0.6F, 1.8F));
    public static final DeferredHolder<EntityType<?>, EntityType<ArmoredHerobrineEntity>> ARMORED_HEROBRINE = register("armored_herobrine", Builder.<ArmoredHerobrineEntity>of(ArmoredHerobrineEntity::new, MobCategory.MONSTER).notInPeaceful().setShouldReceiveVelocityUpdates(true).clientTrackingRange(256).updateInterval(3).fireImmune().sized(0.6F, 1.8F));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<GlaiveHerobrineEntity>> GLAIVE_HEROBRINE = register("glaive_herobrine", Builder.<GlaiveHerobrineEntity>of(GlaiveHerobrineEntity::new, MobCategory.MONSTER).notInPeaceful().setShouldReceiveVelocityUpdates(true).clientTrackingRange(128).updateInterval(3).fireImmune().sized(0.6F, 1.8F));
    public static final DeferredHolder<EntityType<?>, EntityType<ReaperHerobrineEntity>> REAPER_HEROBRINE = register("reaper_herobrine", Builder.<ReaperHerobrineEntity>of(ReaperHerobrineEntity::new, MobCategory.MONSTER).notInPeaceful().setShouldReceiveVelocityUpdates(true).clientTrackingRange(128).updateInterval(3).fireImmune().sized(0.6F, 1.8F));
    public static final DeferredHolder<EntityType<?>, EntityType<SwordsmanHerobrineEntity>> SWORDSMAN_HEROBRINE = register("swordsman_herobrine", Builder.<SwordsmanHerobrineEntity>of(SwordsmanHerobrineEntity::new, MobCategory.MONSTER).notInPeaceful().setShouldReceiveVelocityUpdates(true).clientTrackingRange(128).updateInterval(3).fireImmune().sized(0.6F, 1.8F));
    public static final DeferredHolder<EntityType<?>, EntityType<SledgehammerHerobrineEntity>> SLEDGEHAMMER_HEROBRINE = register("sledgehammer_herobrine", Builder.<SledgehammerHerobrineEntity>of(SledgehammerHerobrineEntity::new, MobCategory.MONSTER).notInPeaceful().setShouldReceiveVelocityUpdates(true).clientTrackingRange(128).updateInterval(3).fireImmune().sized(0.6F, 1.8F));
    public static final DeferredHolder<EntityType<?>, EntityType<AegisHerobrineEntity>> AEGIS_HEROBRINE = register("aegis_herobrine", Builder.<AegisHerobrineEntity>of(AegisHerobrineEntity::new, MobCategory.MONSTER).notInPeaceful().setShouldReceiveVelocityUpdates(true).clientTrackingRange(128).updateInterval(3).fireImmune().sized(0.6F, 1.8F));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<NullEntity>> NULL = register("null", Builder.<NullEntity>of(NullEntity::new, MobCategory.MONSTER).notInPeaceful().setShouldReceiveVelocityUpdates(true).clientTrackingRange(128).updateInterval(3).fireImmune().sized(0.6F, 1.8F));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<AvWarden>> AV_WARDEN = register("av_warden", EntityType.Builder.<AvWarden>of(AvWarden::new, MobCategory.MONSTER).notInPeaceful().sized(0.9F, 2.9F).clientTrackingRange(16).fireImmune());
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<NullSkeletonEntity>> NULL_SKELETON = register("null_skeleton", Builder.<NullSkeletonEntity>of(NullSkeletonEntity::new, MobCategory.MONSTER).notInPeaceful().setShouldReceiveVelocityUpdates(true).clientTrackingRange(128).updateInterval(3).fireImmune().sized(0.6F, 1.8F));
