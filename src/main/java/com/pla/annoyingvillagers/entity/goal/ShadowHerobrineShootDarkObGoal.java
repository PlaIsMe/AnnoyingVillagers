...
public class ShadowHerobrineShootDarkObGoal extends AnimatedMobGoal {
    ...
    public void start() {
        ...
        this.playGoalAnimation(RigAnimationId.POINT_LEFT_HAND_TOWARD, this.target);
    }

    @Override
    public boolean canContinueToUse() {
        return this.isGoalAnimationPlaying(RigAnimationId.POINT_LEFT_HAND_TOWARD);
    }
