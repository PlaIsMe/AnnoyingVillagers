...
public class SledgehammerHerobrineEntity extends HerobrineMob {
    ...
    public void die(@NotNull DamageSource damageSource) {
        ...
        if (this.level() instanceof ServerLevel serverLevel) {
            ...
            eliteHerobrineKnockedEntity.finalizeSpawn(serverLevel, serverLevel.getCurrentDifficultyAt(eliteHerobrineKnockedEntity.blockPosition()), EntitySpawnReason.MOB_SUMMONED, (SpawnGroupData)null);
