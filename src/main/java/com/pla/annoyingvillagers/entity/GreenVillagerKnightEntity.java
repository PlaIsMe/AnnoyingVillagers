...
public class GreenVillagerKnightEntity extends VillagerArmyEntity {
    ...
    public static boolean canSpawn(EntityType<GreenVillagerKnightEntity> entityType, ServerLevelAccessor level, EntitySpawnReason spawnType, BlockPos position, RandomSource random) {
