...
public class ChrisDeadEntity extends PathfinderMob {

    public ChrisDeadEntity(PlayMessages.SpawnEntity spawnentity, Level level) {
        this((EntityType) AnnoyingVillagersModEntities.CHRIS_DEAD.get(), level);
    }

    public ChrisDeadEntity(EntityType<ChrisDeadEntity> entitytype, Level level) {
