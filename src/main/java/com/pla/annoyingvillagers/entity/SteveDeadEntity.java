...
public class SteveDeadEntity extends PathfinderMob {

    public SteveDeadEntity(SpawnEntity spawnentity, Level level) {
        this((EntityType) AnnoyingVillagersModEntities.STEVE_DEAD.get(), level);
    }

    public SteveDeadEntity(EntityType<SteveDeadEntity> entitytype, Level level) {
