...
public class InfectedChrisDeadEntity extends PathfinderMob {

    public InfectedChrisDeadEntity(PlayMessages.SpawnEntity spawnentity, Level level) {
        this((EntityType) AnnoyingVillagersModEntities.INFECTED_CHRIS_DEAD.get(), level);
    }

    public InfectedChrisDeadEntity(EntityType<InfectedChrisDeadEntity> entitytype, Level level) {
