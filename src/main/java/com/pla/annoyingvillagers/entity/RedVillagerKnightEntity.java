...
public class RedVillagerKnightEntity extends VillagerArmyEntity {
    public RedVillagerKnightEntity(SpawnEntity spawnEntity, Level level) {
        this(AnnoyingVillagersModEntities.RED_VILLAGER_KNIGHT.get(), level);
    }
    ...
    public static boolean canSpawn(EntityType<RedVillagerKnightEntity> entityType, ServerLevelAccessor level, MobSpawnType spawnType, BlockPos position, RandomSource random) {
