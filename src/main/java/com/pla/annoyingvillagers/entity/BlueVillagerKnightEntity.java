...
public class BlueVillagerKnightEntity extends VillagerArmyEntity {
    ...
    public static boolean canSpawn(EntityType<BlueVillagerKnightEntity> entityType, ServerLevelAccessor level, EntitySpawnReason spawnType, BlockPos position, RandomSource random) {
