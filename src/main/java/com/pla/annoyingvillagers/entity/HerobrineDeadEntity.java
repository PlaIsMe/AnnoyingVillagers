...
public class HerobrineDeadEntity extends PathfinderMob {

    public HerobrineDeadEntity(PlayMessages.SpawnEntity spawnentity, Level level) {
        this((EntityType) AnnoyingVillagersModEntities.HEROBRINE_DEAD.get(), level);
    }

    public HerobrineDeadEntity(EntityType<HerobrineDeadEntity> entitytype, Level level) {
