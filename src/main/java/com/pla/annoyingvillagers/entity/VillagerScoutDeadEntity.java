...
public class VillagerScoutDeadEntity extends PathfinderMob {

    public VillagerScoutDeadEntity(PlayMessages.SpawnEntity spawnentity, Level level) {
        this((EntityType) AnnoyingVillagersModEntities.VILLAGER_SCOUT_DEAD.get(), level);
    }

    public VillagerScoutDeadEntity(EntityType<VillagerScoutDeadEntity> entitytype, Level level) {
