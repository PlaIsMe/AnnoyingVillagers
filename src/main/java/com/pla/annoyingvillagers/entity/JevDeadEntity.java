...
public class JevDeadEntity extends PathfinderMob {

    public JevDeadEntity(PlayMessages.SpawnEntity spawnentity, Level level) {
        this((EntityType) AnnoyingVillagersModEntities.JEV_DEAD.get(), level);
    }

    public JevDeadEntity(EntityType<JevDeadEntity> entitytype, Level level) {
