...
public class SteveLadder {
    ...
    private static CECombatBehaviors.BehaviorRoot.Builder<MobPatch<?>> addLadderRandomCombatChains(CECombatBehaviors.BehaviorRoot.Builder<MobPatch<?>> root) {
