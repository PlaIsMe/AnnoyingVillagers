                    ...
                    BehaviorRoot.builder()
                            ...
                            .addFirstBehavior(
                                    Behavior.builder()
                                            ...
                                            .animationBehavior(AnimsEpicFightBattleArts.ADVANCED_LANCER_AUTO1, 0.0F)
                                            .addNextBehavior(
                                                    Behavior.builder()
                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                            .withinDistance(0.0D, 4.0D)
                                                            .animationBehavior(AnimsPugilistSteve.TRIDENT_DUAL_AUTO2, 0.0F)
                                                            .addNextBehavior(
                                                                    Behavior.builder()
                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                            .withinDistance(0.0D, 4.0D)
                                                                            .animationBehavior(AnimsEpicFightBattleArts.ADVANCED_DUELIST_SHOOTING_STAR, 0.0F)
                                                                            .addNextBehavior(
                                                                                    Behavior.builder()
                                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                                            .withinDistance(0.0D, 4.0D)
                                                                                            .animationBehavior(AnimsEpicFightAwaken.CUT_DP_AIR_ATTACK, 0.0F)
                                                                                            .addNextBehavior(
                                                                                                    Behavior.builder()
                                                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                                                            .withinDistance(0.0D, 5.0D)
                                                                                                            .animationBehavior(AnimsEpicFightBattleArts.ADVANCED_LANCER_AUTO3, 0.0F)
                                                                                                            .addNextBehavior(
                                                                                                                    Behavior.builder()
                                                                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                                                                            .withinDistance(0.0D, 5.0D)
                                                                                                                            .animationBehavior(AnimsEpicFightBattleArts.ADVANCED_DUELIST_WHIRLEDGE, 0.0F)
                                                                                                            )
                                                                                            )
                                                                            )
                                                            )
