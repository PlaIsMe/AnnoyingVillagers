...
public class PlayerNpcLongsword {
    public static final Builder<MobPatch<?>> LONGSWORD_SHIELD = CECombatBehaviors.builder()
            ...
            .newBehaviorRoot(
                    addLongswordShieldRandomCombatChains(
                            BehaviorRoot.builder()
                                    .priority(1.0D)
                                    .weight(40.0D)
                                    .maxCooldown(20)
    ...
    public static final Builder<MobPatch<?>> LONGSWORD = CECombatBehaviors.builder()
            ...
            .newBehaviorRoot(
                    addLongswordRandomCombatChains(
                            BehaviorRoot.builder()
                                    .priority(1.0D)
                                    .weight(40.0D)
                                    .maxCooldown(20)
    ...
    private static CECombatBehaviors.BehaviorRoot.Builder<MobPatch<?>> addLongswordShieldRandomCombatChains(CECombatBehaviors.BehaviorRoot.Builder<MobPatch<?>> root) {
    ...
    private static CECombatBehaviors.BehaviorRoot.Builder<MobPatch<?>> addLongswordRandomCombatChains(CECombatBehaviors.BehaviorRoot.Builder<MobPatch<?>> root) {
        return CombatCommon.addRandomCombatChains(
                root,
                CombatCommon.animations(
                        Animations.LONGSWORD_AUTO1,
