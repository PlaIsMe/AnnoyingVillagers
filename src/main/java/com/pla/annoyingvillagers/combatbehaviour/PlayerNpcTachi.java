...
public class PlayerNpcTachi {
    ...
    private static CECombatBehaviors.BehaviorRoot.Builder<MobPatch<?>> addTachiRandomCombatChains(CECombatBehaviors.BehaviorRoot.Builder<MobPatch<?>> root) {
