...
public class PlayerNpcWoodenDoor {
    public static final Builder<MobPatch<?>> WOODEN_DOOR = CECombatBehaviors.builder()
            ...
            .newBehaviorRoot(
                    addWoodenDoorRandomCombatChains(
                            BehaviorRoot.builder()
                                    .priority(1.0D)
                                    .weight(40.0D)
                                    .maxCooldown(20)
    ...
    private static CECombatBehaviors.BehaviorRoot.Builder<MobPatch<?>> addWoodenDoorRandomCombatChains(CECombatBehaviors.BehaviorRoot.Builder<MobPatch<?>> root) {
