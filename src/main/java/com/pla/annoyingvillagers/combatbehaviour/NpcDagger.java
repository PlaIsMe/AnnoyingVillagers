...
public class NpcDagger {
    ...
    public static final Builder<MobPatch<?>> DUAL_DAGGER = CECombatBehaviors.builder()
            ...
            .newBehaviorRoot(
                    addDualDaggerRandomCombatChains(
                            BehaviorRoot.builder()
                                    .priority(1.0D)
                                    .weight(40.0D)
                                    .maxCooldown(20)
    ...
    private static CECombatBehaviors.BehaviorRoot.Builder<MobPatch<?>> addDaggerRandomCombatChains(CECombatBehaviors.BehaviorRoot.Builder<MobPatch<?>> root) {
    ...
    private static CECombatBehaviors.BehaviorRoot.Builder<MobPatch<?>> addDualDaggerRandomCombatChains(CECombatBehaviors.BehaviorRoot.Builder<MobPatch<?>> root) {
        return CombatCommon.addRandomCombatChains(
                root,
                CombatCommon.animations(
