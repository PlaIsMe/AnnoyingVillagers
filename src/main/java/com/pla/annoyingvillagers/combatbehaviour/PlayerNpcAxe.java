...
public class PlayerNpcAxe {
    ...
    private static CECombatBehaviors.BehaviorRoot.Builder<MobPatch<?>> addAxeRandomCombatChains(CECombatBehaviors.BehaviorRoot.Builder<MobPatch<?>> root) {
