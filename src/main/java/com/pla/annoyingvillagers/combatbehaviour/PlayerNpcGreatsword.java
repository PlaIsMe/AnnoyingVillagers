...
public class PlayerNpcGreatsword {
    public static final Builder<MobPatch<?>> GREATSWORD = CECombatBehaviors.builder()
            ...
            .newBehaviorRoot(
                    addGreatswordRandomCombatChains(
                            BehaviorRoot.builder()
                                    .priority(1.0D)
                                    .weight(40.0D)
                                    .maxCooldown(20)
    ...
    private static CECombatBehaviors.BehaviorRoot.Builder<MobPatch<?>> addGreatswordRandomCombatChains(CECombatBehaviors.BehaviorRoot.Builder<MobPatch<?>> root) {
