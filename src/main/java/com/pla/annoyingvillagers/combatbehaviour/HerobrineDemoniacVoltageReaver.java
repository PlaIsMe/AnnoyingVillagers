...
public class HerobrineDemoniacVoltageReaver {
    public static final Builder<MobPatch<?>> DEMONIAC_VOLTAGE_REAVER = CECombatBehaviors.builder()
            ...
            .newBehaviorRoot(
                    addDemoniacVoltageReaverRandomCombatChains(
                            BehaviorRoot.builder()
                                    .priority(1.0D)
                                    .weight(40.0D)
                                    .maxCooldown(20)
    ...
    private static CECombatBehaviors.BehaviorRoot.Builder<MobPatch<?>> addDemoniacVoltageReaverRandomCombatChains(CECombatBehaviors.BehaviorRoot.Builder<MobPatch<?>> root) {
