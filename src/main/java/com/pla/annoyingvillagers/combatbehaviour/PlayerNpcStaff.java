...
public class PlayerNpcStaff {
    ...
    private static CECombatBehaviors.BehaviorRoot.Builder<MobPatch<?>> addStaffRandomCombatChains(CECombatBehaviors.BehaviorRoot.Builder<MobPatch<?>> root) {
