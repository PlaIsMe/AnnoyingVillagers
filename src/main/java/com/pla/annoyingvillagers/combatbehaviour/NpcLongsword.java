...
public class NpcLongsword {
    ...
    public static final Builder<MobPatch<?>> AV_LONGSWORD_SHIELD = CECombatBehaviors.builder()
            .newBehaviorRoot(
                    BehaviorRoot.builder()
                            .priority(4.0D)
                            .weight(1000.0D)
    ...
    public static final Builder<MobPatch<?>> AV_LONGSWORD = CECombatBehaviors.builder()
            .newBehaviorRoot(
                    BehaviorRoot.builder()
                            .priority(4.0D)
                            .weight(1000.0D)
