...
public class AnimsBow {
    ...
    public static void build(AnimationBuilder builder) {
        ...
        BOW_AUTO_1 = builder.nextAccessor("biped/bow/bow_auto1",
        ...
        BOW_AUTO_2 = builder.nextAccessor("biped/bow/bow_auto2",
        ...
        BOW_AUTO_3 = builder.nextAccessor("biped/bow/bow_auto3",
        ...
        BOW_AUTO_4 = builder.nextAccessor("biped/bow/bow_auto4",
        ...
        BOW_AUTO_5 = builder.nextAccessor("biped/bow/bow_auto5",
