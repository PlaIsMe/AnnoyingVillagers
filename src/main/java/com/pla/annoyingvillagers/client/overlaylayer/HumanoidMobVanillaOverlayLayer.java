...
public class HumanoidMobVanillaOverlayLayer<T extends LivingEntity, M extends HumanoidModel<T>> extends RenderLayer<T, M> {
    public HumanoidMobVanillaOverlayLayer(RenderLayerParent<T, M> renderer) {
        super(renderer);
    }
