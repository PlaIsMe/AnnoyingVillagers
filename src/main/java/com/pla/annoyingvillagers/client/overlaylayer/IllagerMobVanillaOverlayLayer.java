...
public class IllagerMobVanillaOverlayLayer<T extends AbstractIllager, M extends EntityModel<T>> extends RenderLayer<T, M> {
    public IllagerMobVanillaOverlayLayer(RenderLayerParent<T, M> renderer) {
        super(renderer);
    }
