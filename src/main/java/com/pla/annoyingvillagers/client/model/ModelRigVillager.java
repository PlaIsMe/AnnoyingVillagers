...
public class ModelRigVillager<T extends Mob> extends HumanoidModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(40, 46).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 7.0F, 4.0F), PartPose.offset(-5.0F, 2.0F, 0.0F));

        PartDefinition right_hand = right_arm.addOrReplaceChild("right_hand", CubeListBuilder.create().texOffs(40, 52).addBox(-3.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F), PartPose.offset(0.0F, 4.0F, 0.0F));

        right_hand.addOrReplaceChild("right_hand_top_face", CubeListBuilder.create().texOffs(40, 46).addBox(-3.0F, -0.001F, -2.0F, 4.0F, 0.0F, 4.0F, Set.of(Direction.UP)), PartPose.offset(0.0F, 0.0F, 0.0F));

        right_hand.addOrReplaceChild("right_hand_bottom_face", CubeListBuilder.create().texOffs(44, 46).addBox(-3.0F, 6.001F, -2.0F, 4.0F, 0.0F, 4.0F, Set.of(Direction.DOWN)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition right_tool = right_hand.addOrReplaceChild("right_tool", CubeListBuilder.create(), PartPose.offset(0.0F, 6.0F, 0.0F));

        PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(40, 46).mirror().addBox(-1.0F, -2.0F, -2.0F, 4.0F, 7.0F, 4.0F), PartPose.offset(5.0F, 2.0F, 0.0F));

        PartDefinition left_hand = left_arm.addOrReplaceChild("left_hand", CubeListBuilder.create().texOffs(40, 52).mirror().addBox(-1.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F), PartPose.offset(0.0F, 4.0F, 0.0F));

        left_hand.addOrReplaceChild("left_hand_top_face", CubeListBuilder.create().texOffs(40, 46).mirror().addBox(-1.0F, -0.001F, -2.0F, 4.0F, 0.0F, 4.0F, Set.of(Direction.UP)), PartPose.offset(0.0F, 0.0F, 0.0F));

        left_hand.addOrReplaceChild("left_hand_bottom_face", CubeListBuilder.create().texOffs(44, 46).mirror().addBox(-1.0F, 6.001F, -2.0F, 4.0F, 0.0F, 4.0F, Set.of(Direction.DOWN)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition left_tool = left_hand.addOrReplaceChild("left_tool", CubeListBuilder.create(), PartPose.offset(0.0F, 6.0F, 0.0F));

        PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(0, 22).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 7.0F, 4.0F), PartPose.offset(-2.0F, 12.0F, 0.0F));

        PartDefinition right_lower_leg = right_leg.addOrReplaceChild("right_lower_leg", CubeListBuilder.create().texOffs(0, 28).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F), PartPose.offset(0.0F, 6.0F, 0.0F));

        right_lower_leg.addOrReplaceChild("right_lower_leg_top_face", CubeListBuilder.create().texOffs(0, 22).addBox(-2.0F, -0.001F, -2.0F, 4.0F, 0.0F, 4.0F, Set.of(Direction.UP)), PartPose.offset(0.0F, 0.0F, 0.0F));

        right_lower_leg.addOrReplaceChild("right_lower_leg_bottom_face", CubeListBuilder.create().texOffs(4, 22).addBox(-2.0F, 6.001F, -2.0F, 4.0F, 0.0F, 4.0F, Set.of(Direction.DOWN)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(0, 22).mirror().addBox(-2.0F, 0.0F, -2.0F, 4.0F, 7.0F, 4.0F), PartPose.offset(2.0F, 12.0F, 0.0F));

        PartDefinition left_lower_leg = left_leg.addOrReplaceChild("left_lower_leg", CubeListBuilder.create().texOffs(0, 28).mirror().addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F), PartPose.offset(0.0F, 6.0F, 0.0F));

        left_lower_leg.addOrReplaceChild("left_lower_leg_top_face", CubeListBuilder.create().texOffs(0, 22).mirror().addBox(-2.0F, -0.001F, -2.0F, 4.0F, 0.0F, 4.0F, Set.of(Direction.UP)), PartPose.offset(0.0F, 0.0F, 0.0F));
