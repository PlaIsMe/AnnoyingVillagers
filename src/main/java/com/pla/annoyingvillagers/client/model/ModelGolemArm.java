...
public class ModelGolemArm extends HierarchicalModel<GolemArms> {
	...
	private final ModelPart garm_up_1_L;
	private final ModelPart garm_up_2_L;
	private final ModelPart garm_up_3_L;
	private final ModelPart garm_up_4_L;
	...
	public ModelGolemArm(ModelPart root) {
		...
		this.garm_up_1_L = this.Chest.getChild("garm_up_1_L");
		this.garm_up_2_L = this.garm_up_1_L.getChild("garm_up_2_L");
		this.garm_up_3_L = this.garm_up_2_L.getChild("garm_up_3_L");
		this.garm_up_4_L = this.garm_up_3_L.getChild("garm_up_4_L");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition garm_up_1_L = Chest.addOrReplaceChild("garm_up_1_L", CubeListBuilder.create().texOffs(-6, -4).addBox(-2.0454F, -4.0071F, -3.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
		.texOffs(60, 74).addBox(-2.0454F, -3.0071F, -3.0F, 4.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.2805F, -4.0356F, 4.9955F, 0.0F, 0.0F, 0.7854F));

		PartDefinition garm_up_2_L = garm_up_1_L.addOrReplaceChild("garm_up_2_L", CubeListBuilder.create().texOffs(-1, 1).addBox(-2.0454F, 2.5723F, 2.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition garm_up_3_L = garm_up_2_L.addOrReplaceChild("garm_up_3_L", CubeListBuilder.create().texOffs(-6, -4).addBox(-0.0454F, 1.5532F, -3.0F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F))
		...
		PartDefinition garm_up_4_L = garm_up_3_L.addOrReplaceChild("garm_up_4_L", CubeListBuilder.create().texOffs(60, 80).addBox(-2.0454F, -6.8011F, -3.0F, 4.0F, 8.0F, 6.0F, new CubeDeformation(0.0F))
		...
		.texOffs(60, 74).addBox(-1.9546F, -3.0071F, -3.0F, 4.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.2807F, -4.0357F, 4.9953F, 0.0F, 0.0F, -0.7854F));
	...
	public void setupAnim(@NotNull GolemArms entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (owner != null) {
			boolean moving = owner.getDeltaMovement().horizontalDistanceSqr() > 0.0025D;
