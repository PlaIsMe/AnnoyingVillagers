...
public class ModelAvGolem extends HierarchicalModel<GolemWarriors> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Root = partdefinition.addOrReplaceChild("Root", CubeListBuilder.create(), PartPose.offset(0.0F, 9.5018F, 0.0F));

		PartDefinition body = Root.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 70).addBox(-4.5F, -5.1553F, -3.0F, 9.0F, 5.0F, 6.0F, new CubeDeformation(0.5F)), PartPose.offset(0.0F, -1.3465F, 0.0F));

		PartDefinition chest = body.addOrReplaceChild("chest", CubeListBuilder.create().texOffs(0, 40).addBox(-9.0F, -11.8731F, -6.0F, 18.0F, 12.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -5.2822F, 0.0F));

		PartDefinition head = chest.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -9.8902F, -3.9884F, 8.0F, 10.0F, 8.0F, new CubeDeformation(0.0F))
		.texOffs(24, 0).addBox(-1.0F, -2.8902F, -5.9884F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -11.9829F, -2.5116F));

		PartDefinition shoudler_L = chest.addOrReplaceChild("shoudler_L", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -11.9829F, 0.0F, 0.0F, 0.0F, 1.7311F));

		PartDefinition arm_1_L = shoudler_L.addOrReplaceChild("arm_1_L", CubeListBuilder.create().texOffs(-6, -4).addBox(-2.0454F, -4.0071F, -3.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
		.texOffs(60, 74).addBox(-2.0454F, -3.0071F, -3.0F, 4.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.1662F, -11.07F, 0.0F, 0.0F, 0.0F, 1.4105F));

		PartDefinition arm_2_L = arm_1_L.addOrReplaceChild("arm_2_L", CubeListBuilder.create().texOffs(1, 0).addBox(-0.6454F, -7.0215F, -1.0F, 1.2F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.4856F, 0.0F));

		PartDefinition arm_3_L = arm_2_L.addOrReplaceChild("arm_3_L", CubeListBuilder.create().texOffs(-1, 1).addBox(-2.0454F, 2.5723F, 2.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		.texOffs(-4, -2).addBox(-2.0454F, 2.5723F, -2.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -7.0938F, 0.0F));

		PartDefinition arm_4_L = arm_3_L.addOrReplaceChild("arm_4_L", CubeListBuilder.create().texOffs(1, 0).addBox(-0.6454F, -6.9277F, -1.0F, 1.2F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition arm_5_L = arm_4_L.addOrReplaceChild("arm_5_L", CubeListBuilder.create().texOffs(-6, -4).addBox(-0.0454F, 1.5532F, -3.0F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F))
		...
		.texOffs(-6, -4).addBox(-2.0454F, 2.5532F, -3.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -6.9809F, 0.0F));

		PartDefinition arm_6_L = arm_5_L.addOrReplaceChild("arm_6_L", CubeListBuilder.create().texOffs(1, 0).addBox(-0.6454F, -6.9298F, -1.0F, 1.2F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.017F, 0.0F));

		PartDefinition arm_7_L = arm_6_L.addOrReplaceChild("arm_7_L", CubeListBuilder.create().texOffs(60, 80).addBox(-2.0454F, -6.8011F, -3.0F, 4.0F, 8.0F, 6.0F, new CubeDeformation(0.0F))
		...
		.texOffs(64, 77).addBox(-0.0454F, 1.1989F, -3.0F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -6.6288F, 0.0F));

		PartDefinition Tool_L = arm_7_L.addOrReplaceChild("Tool_L", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -5.4125F, 0.0F, 1.5708F, 0.0F, 0.0F));

		PartDefinition shoudler_R = chest.addOrReplaceChild("shoudler_R", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -11.9829F, 0.0F, 0.0F, 0.0F, -1.7311F));

		PartDefinition arm_1_R = shoudler_R.addOrReplaceChild("arm_1_R", CubeListBuilder.create().texOffs(-6, -4).addBox(0.0454F, -4.0071F, -3.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
		.texOffs(60, 74).addBox(-1.9546F, -3.0071F, -3.0F, 4.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.1662F, -11.07F, 0.0F, 0.0F, 0.0F, -1.4105F));

		PartDefinition arm_2_R = arm_1_R.addOrReplaceChild("arm_2_R", CubeListBuilder.create().texOffs(1, 0).addBox(-0.5546F, -7.0215F, -1.0F, 1.2F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.4856F, 0.0F));

		PartDefinition arm_3_R = arm_2_R.addOrReplaceChild("arm_3_R", CubeListBuilder.create().texOffs(-1, 1).addBox(0.0454F, 2.5723F, 2.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		.texOffs(-4, -2).addBox(0.0454F, 2.5723F, -2.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -7.0938F, 0.0F));

		PartDefinition arm_4_R = arm_3_R.addOrReplaceChild("arm_4_R", CubeListBuilder.create().texOffs(1, 0).addBox(-0.5546F, -6.9277F, -1.0F, 1.2F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition arm_5_R = arm_4_R.addOrReplaceChild("arm_5_R", CubeListBuilder.create().texOffs(60, 74).addBox(-1.9546F, -3.4468F, -3.0F, 4.0F, 5.0F, 6.0F, new CubeDeformation(0.0F))
		...
		.texOffs(-6, -4).addBox(0.0454F, 2.5532F, -3.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -6.9809F, 0.0F));

		PartDefinition arm_6_R = arm_5_R.addOrReplaceChild("arm_6_R", CubeListBuilder.create().texOffs(1, 0).addBox(-0.5546F, -6.9298F, -1.0F, 1.2F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.017F, 0.0F));

		PartDefinition arm_7_R = arm_6_R.addOrReplaceChild("arm_7_R", CubeListBuilder.create().texOffs(60, 80).addBox(-1.9546F, -6.8011F, -3.0F, 4.0F, 8.0F, 6.0F, new CubeDeformation(0.0F))
		...
		.texOffs(-4, -2).addBox(0.0454F, 1.1989F, -2.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -6.6288F, 0.0F));

		PartDefinition Tool_R = arm_7_R.addOrReplaceChild("Tool_R", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -5.4125F, 0.0F, 1.5708F, 0.0F, 0.0F));

		PartDefinition leg_up_L = Root.addOrReplaceChild("leg_up_L", CubeListBuilder.create().texOffs(60, 0).addBox(-2.968F, -5.8643F, 1.9245F, 5.0065F, 1.0329F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(60, 0).addBox(-3.001F, -4.8644F, -3.0755F, 5.0329F, 5.0329F, 6.0F, new CubeDeformation(0.0F))
		.texOffs(60, 0).addBox(-2.968F, -5.8643F, -3.0755F, 5.0065F, 1.0329F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(60, 0).addBox(-2.968F, -5.8643F, -2.0755F, 5.0065F, 1.0329F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.5755F, -1.3465F, 0.0F, 1.5708F, -1.5642F, 1.5708F));

		PartDefinition leg_down_L = leg_up_L.addOrReplaceChild("leg_down_L", CubeListBuilder.create().texOffs(60, 0).addBox(-3.0033F, -8.9524F, -3.0755F, 5.0545F, 10.0272F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -6.9034F, 0.0F, 0.0F, 0.0F, 0.0121F));

		PartDefinition knee_L = leg_up_L.addOrReplaceChild("knee_L", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -6.9034F, 0.0F, 0.0F, 0.0F, -1.5642F));

		PartDefinition leg_up_R = Root.addOrReplaceChild("leg_up_R", CubeListBuilder.create().texOffs(37, 0).addBox(-2.0319F, -4.8644F, -3.0755F, 5.0329F, 5.0329F, 6.0F, new CubeDeformation(0.0F))
		.texOffs(37, 0).addBox(-2.0319F, -4.8644F, -3.0755F, 4.9999F, 0.033F, 6.0F, new CubeDeformation(0.0F))
		.texOffs(37, 0).addBox(-2.0385F, -5.8643F, -3.0755F, 5.0065F, 1.0329F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(37, 0).addBox(-2.0385F, -5.8643F, 1.9245F, 5.0065F, 1.0329F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(37, 0).addBox(-2.0385F, -5.8643F, -2.0755F, 5.0065F, 1.0329F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.5755F, -1.3465F, 0.0F, 1.5708F, 1.5642F, -1.5708F));

		PartDefinition leg_down_R = leg_up_R.addOrReplaceChild("leg_down_R", CubeListBuilder.create().texOffs(37, 0).addBox(-2.0513F, -8.9524F, -3.0755F, 5.0545F, 10.0272F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -6.9034F, 0.0F, 0.0F, 0.0F, -0.0121F));

		PartDefinition knee_R = leg_up_R.addOrReplaceChild("knee_R", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -6.9034F, 0.0F, 0.0F, 0.0F, 1.5642F));

		PartDefinition arm_s_L = partdefinition.addOrReplaceChild("arm_s_L", CubeListBuilder.create(), PartPose.offsetAndRotation(10.9546F, -7.5071F, 0.0F, 0.0F, 0.0F, 3.1416F));

		PartDefinition arm_s_R = partdefinition.addOrReplaceChild("arm_s_R", CubeListBuilder.create(), PartPose.offsetAndRotation(-10.9546F, -7.5071F, 0.0F, 0.0F, 0.0F, 3.1416F));
