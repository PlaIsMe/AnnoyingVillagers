...
@OnlyIn(Dist.CLIENT)
public final class GroundSlamParticle extends TextureSheetParticle {
    private final double yaw;
    private final double pitch;
    private final double roll;
    private final SpriteSet sprites;

    private GroundSlamParticle(ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed,
    ...
    @OnlyIn(Dist.CLIENT)
    public record Provider(SpriteSet sprites) implements ParticleProvider<GroundSlamOptions> {
        @Override
        public @NotNull Particle createParticle(@NotNull GroundSlamOptions options, @NotNull ClientLevel level,
