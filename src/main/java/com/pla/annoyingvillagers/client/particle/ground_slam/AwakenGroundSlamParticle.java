...
@OnlyIn(Dist.CLIENT)
public class AwakenGroundSlamParticle extends TextureSheetParticle {
    private final double yaw;
    private final double pitch;
    private final double roll;
    protected final SpriteSet sprites;

    protected AwakenGroundSlamParticle(ClientLevel level, double x, double y, double z,
    ...
    @OnlyIn(Dist.CLIENT)
    public record Provider(SpriteSet sprites) implements ParticleProvider<AwakenGroundSlamOptions> {
        @Override
        public @NotNull Particle createParticle(@NotNull AwakenGroundSlamOptions options, @NotNull ClientLevel level,
                                                double x, double y, double z,
                                                double xSpeed, double ySpeed, double zSpeed) {
            return new AwakenGroundSlamParticle(level, x, y, z, xSpeed, ySpeed, zSpeed,
