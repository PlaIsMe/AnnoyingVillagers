...
public final class VacuumSliceRenderer extends EntityRenderer<VacuumSliceEntity> {
    ...
    @Override
    public void render(VacuumSliceEntity entity,float entityYaw,float partialTick,PoseStack poseStack,@NotNull MultiBufferSource bufferSource,int packedLight) {
        poseStack.pushPose();
