...
public class AvGolemLivingAnimations {
	...
	public static final AnimationDefinition RUN = AnimationDefinition.Builder.withLength(1.0F)
		...
		.addAnimation("leg_up_L", new AnimationChannel(AnimationChannel.Targets.ROTATION,
			...
			new Keyframe(0.7F, KeyframeAnimations.degreeVec(-0.9121F, -6.0678F, 0.6171F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.75F, KeyframeAnimations.degreeVec(-0.2529F, -20.9363F, -0.0485F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.8F, KeyframeAnimations.degreeVec(-0.1908F, -28.3952F, -0.1194F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.85F, KeyframeAnimations.degreeVec(-0.2418F, -23.1816F, -0.0782F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.9F, KeyframeAnimations.degreeVec(-0.3969F, -15.4582F, 0.0515F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.95F, KeyframeAnimations.degreeVec(-5.379F, -1.7287F, 4.9707F), AnimationChannel.Interpolations.LINEAR),
		...
		.addAnimation("leg_up_R", new AnimationChannel(AnimationChannel.Targets.ROTATION,
			...
			new Keyframe(0.2F, KeyframeAnimations.degreeVec(-0.9121F, 6.0678F, -0.6171F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.25F, KeyframeAnimations.degreeVec(-0.2529F, 20.9363F, 0.0485F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.3F, KeyframeAnimations.degreeVec(-0.1908F, 28.3952F, 0.1194F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.35F, KeyframeAnimations.degreeVec(-0.2418F, 23.1816F, 0.0782F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.4F, KeyframeAnimations.degreeVec(-0.397F, 15.4582F, -0.0516F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.45F, KeyframeAnimations.degreeVec(-1.4775F, 5.2102F, -1.0725F), AnimationChannel.Interpolations.LINEAR),
	...
	public static final AnimationDefinition WALK = AnimationDefinition.Builder.withLength(1.0F)
		...
		.addAnimation("leg_up_L", new AnimationChannel(AnimationChannel.Targets.ROTATION,
			...
			new Keyframe(0.15F, KeyframeAnimations.degreeVec(-180.0F, -4.2751F, -180.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.2F, KeyframeAnimations.degreeVec(-180.0F, -14.111F, -180.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.25F, KeyframeAnimations.degreeVec(-180.0F, -23.6549F, -180.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.3F, KeyframeAnimations.degreeVec(-180.0F, -31.4821F, -180.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.35F, KeyframeAnimations.degreeVec(-180.0F, -36.6821F, -180.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.4F, KeyframeAnimations.degreeVec(-180.0F, -39.0585F, -180.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.45F, KeyframeAnimations.degreeVec(-180.0F, -33.4776F, -180.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.5F, KeyframeAnimations.degreeVec(-180.0F, -16.8505F, -180.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.55F, KeyframeAnimations.degreeVec(-180.0F, -18.7485F, -180.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.6F, KeyframeAnimations.degreeVec(-180.0F, -19.5684F, -180.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.7F, KeyframeAnimations.degreeVec(-180.0F, -18.0722F, -180.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.75F, KeyframeAnimations.degreeVec(-180.0F, -16.145F, -180.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.8F, KeyframeAnimations.degreeVec(-180.0F, -12.4965F, -180.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.9F, KeyframeAnimations.degreeVec(-180.0F, -1.6249F, -180.0F), AnimationChannel.Interpolations.LINEAR),
		...
		.addAnimation("leg_up_R", new AnimationChannel(AnimationChannel.Targets.ROTATION,
			...
			new Keyframe(0.45F, KeyframeAnimations.degreeVec(0.0F, 4.8399F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.5F, KeyframeAnimations.degreeVec(0.0F, 8.0496F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.6F, KeyframeAnimations.degreeVec(0.0F, 3.9924F, 0.0F), AnimationChannel.Interpolations.LINEAR),
