...
public class RigItemInHandLayer<T extends Mob> extends ItemInHandLayer<T, ModelRig<T>> {
    private static final float ITEM_X_OFFSET = 1.0F / 16.0F;
    private static final float ITEM_DEPTH_OFFSET = 2.0F / 16.0F;
    private final ItemInHandRenderer itemInHandRenderer;

    public RigItemInHandLayer(RenderLayerParent<T, ModelRig<T>> renderer, ItemInHandRenderer itemInHandRenderer) {
