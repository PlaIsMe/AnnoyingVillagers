...
public class RigArrowLayer<T extends Mob> extends RenderLayer<T, ModelRig<T>> {
    private final EntityRenderDispatcher dispatcher;
    public RigArrowLayer(EntityRendererProvider.Context context, RenderLayerParent<T, ModelRig<T>> renderer) {
        super(renderer);
