...
public class RigArrowLayer<T extends Mob> extends RenderLayer<LegacyEntityRenderState<T>, ModelRig<T>> {
    private final ArrowModel arrowModel;
    private final ArrowRenderState arrowState = new ArrowRenderState();
    public RigArrowLayer(EntityRendererProvider.Context context, RenderLayerParent<LegacyEntityRenderState<T>, ModelRig<T>> renderer) {
        super(renderer);
